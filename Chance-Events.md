This flow illustrates how to create a randomly-triggered event based on a percentage probability. Each time the flow is called (e.g. via an inject node set to repeat at a fixed interval), a 
